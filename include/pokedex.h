...
#define NATIONAL_DEX_SNITCHBUG 13
...
extern const u8 DEX_ENTRY_CRUMBUG_A[];
extern const u8 DEX_ENTRY_BREADBUG_A[];
extern const u8 DEX_ENTRY_HONEYWISP_A[];
extern const u8 DEX_ENTRY_DANDELFLY_A[];
extern const u8 DEX_ENTRY_DOWNYSNAGRET_A[];
extern const u8 DEX_ENTRY_ARISTOCRABOFFSPRING_A[];
extern const u8 DEX_ENTRY_ARISTOCRAB_A[];
extern const u8 DEX_ENTRY_HERMITCRAWMAD_A[];
extern const u8 DEX_ENTRY_BUGEYEDCRAWMAD_A[];
extern const u8 DEX_ENTRY_DWARFBULBORB_A[];
extern const u8 DEX_ENTRY_DWARFBULBORB_G[];
extern const u8 DEX_ENTRY_DWARFORANGEBULBORB_A[];
extern const u8 DEX_ENTRY_VEHEAMOTHPHOSBAT_A[];
extern const u8 DEX_ENTRY_PUCKERINGBLINNOW_A[];
extern const u8 DEX_ENTRY_SPUTTLEFISH_A[];
extern const u8 DEX_ENTRY_PRICKLEPUFF_G[];
...
extern const u8 DEX_ENTRY_BULBMIN_H[];
extern const u8 DEX_ENTRY_ADULTBULBMIN_H[];
...
extern const u8 DEX_CATEGORY_PRICKLEPUFF_G[];
...
extern const u8 DEX_CATEGORY_BULBMIN_H[];
