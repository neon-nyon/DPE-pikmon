...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_FLNTBEETLE] =         {{EVO_LEVEL, 7, SPECIES_DOODLEBUG, 0}},
	[SPECIES_DOODLEBUG] =          {{EVO_LEVEL, 10, SPECIES_GLNTBEETLE, 0}},
	[SPECIES_GLNTBEETLE] =       {{EVO_GIGANTAMAX, TRUE, SPECIES_GLNTBEETLE_GIGA, 0}},
	...
	[SPECIES_GLNTBEETLE_GIGA] =  {{EVO_GIGANTAMAX, FALSE, SPECIES_GLNTBEETLE, 0}},
